...
- KeyboardInterrupt is managed by the the event loop
  Goal: Client will catch a signal and initiate shutdown (send Logout, wait for response)
  Current: Hard stop -- connection is simply shut down
